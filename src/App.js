...
function App() {
  ...
  return (
    <div className=''>
      <nav className="bg-red-100 border-black px-200 sm:px-40 py-2.5 rounded-b-xl dark:bg-gray-900 ">
      ...
      <div className='w-2/4' >
        ...
        <h2 className='text-4xl text-white font-extrabold'>Juan Carlos Gonzalez Huerta</h2>
        <br></br>
        <p className='text-xl text-gray-400'>{t("body.descripcion")}</p>
        <br></br>
        <br></br>
        <button  onClick={()=>{setCount(count + 1)}} class="bg-red-500 hover:bg-red-700 text-black font-bold py-5 px-12 border border-red-700 rounded">
        {t("body.contador")}
        </button>
        <p className=' text-white'>{t("body.contador2")}: {count}</p>
        <br></br>
        <p className='text-xl text-white'>{t("body.DescripcionTecnologias")}</p>
